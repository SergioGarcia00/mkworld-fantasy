-- Allow saving a lineup with 6 to 10 roster players.
...
begin
  ...
  if roster_count < 6 or roster_count > 10 then raise exception 'Debes tener entre 6 y 10 jugadores antes de confirmar la alineación'; end if;
  if current_budget < 0 then raise exception 'Debes tener un presupuesto de 0 € o más antes de confirmar la alineación'; end if;
