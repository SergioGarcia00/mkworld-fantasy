...
// Current ISO 3166-1 codes only: Intl also accepts obsolete aliases such as FX.
...
const codes = new Map(regions.map(code => [names.of(code)!.toLowerCase(), code.toLowerCase()]));
codes.set('turkey', 'tr');
